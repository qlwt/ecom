...
export type EPAction__BtnToggle_Props = {
...
export const EPAction_BtnToggle = r.forwardRef<HTMLButtonElement, EPAction__BtnToggle_Props>((props, f_ref) => {
    ...
    return <button
        ...
        className={cl(st.btn, st.btn_toggle, {
...
export default EPAction_BtnToggle
