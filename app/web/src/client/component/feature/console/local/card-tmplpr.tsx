...
export type ELCon__CardTmplPr_Props = Readonly<{
    readonly node: cc.RemDef["tmplpr"]["joins"]["core"]
}>

export const ELCon_CardTmplPr: r.FC<ELCon__CardTmplPr_Props> = props => {
    ...
    const href = urlmap.console.edit_tmplpr({ id: props.node.id })
